...
declare namespace Cypress {
    interface Chainable {
         ...
         */
        GETcontacts(email: string, limit: number, failOnStatusCode?: boolean): Chainable<Response<ContactList>>;

        /**
         * Custom command to update contact by id.
         * @example cy.PATCHcontact(id,contact object, true)
         */
        PATCHcontact(id: string, contact: object, failOnStatusCode?: boolean): Chainable<Response<Contact>>;
    }
}
